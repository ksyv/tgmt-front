...
import {
  DomSanitizer
} from "./chunk-6HZQS52T.js";
import "./chunk-UMC3SZXB.js";
import {
  DOCUMENT,
  NgClass,
  isPlatformServer
} from "./chunk-QYKDGM6F.js";
import {
  ChangeDetectorRef,
  Component,
  DestroyRef,
  ...
  constructor(injector, config) {
    ...
    this.quill$ = (0, import_rxjs2.defer)(() => __async(this, null, function* () {
      if (!this.Quill) {
        ...
        const quillImport = yield import("./quill-62J6TAWT.js");
    ...
    return __async(this, null, function* () {
      if (Array.isArray(customModules)) {
        for (let {
          ...
          if ((0, import_rxjs2.isObservable)(implementation)) {
            implementation = yield (0, import_rxjs2.firstValueFrom)(implementation);
          }
...
var _QuillEditorBase = class _QuillEditorBase {
  ...
  ngAfterViewInit() {
    ...
    this.quillSubscription = this.service.getQuill().pipe((0, import_operators2.mergeMap)((Quill) => {
